...
SUPEE-7405-CE-1-4-0-1 | CE_1.4.0.1 | v1 | 914a59d6d5a3ac981ece5a27ec20080f6f0c7160 | Sat Jan 16 12:15:17 2016 +0200 | bbaeec127e..914a59d6d5
...
@@ -284,15 +284,21 @@ class Mage_Checkout_CartController extends Mage_Core_Controller_Front_Action
      */
...
index 47fcced..6bc8359 100644
--- app/code/core/Mage/Sales/Model/Quote/Address.php
+++ app/code/core/Mage/Sales/Model/Quote/Address.php
@@ -785,7 +785,12 @@ class Mage_Sales_Model_Quote_Address extends Mage_Customer_Model_Address_Abstrac
      */
...
index 21b208d..215a459 100644
--- app/code/core/Mage/Sales/Model/Quote/Item.php
+++ app/code/core/Mage/Sales/Model/Quote/Item.php
@@ -356,25 +356,34 @@ class Mage_Sales_Model_Quote_Item extends Mage_Sales_Model_Quote_Item_Abstract
...
diff --git app/design/adminhtml/default/default/template/sales/order/create/coupons/form.phtml app/design/adminhtml/default/default/template/sales/order/create/coupons/form.phtml
index 92456b4..e3441b4 100644
...
+                <p><strong><?php echo $this->escapeHtml($this->getCouponCode()); ?></strong> [<a href="#" onclick="order.applyCoupon(''); return false;" title="<?php echo Mage::helper('core')->jsQuoteEscape($this->__('Remove Coupon Code')) ?>"><?php echo Mage::helper('sales')->__('Remove') ?></a>]</p>
             <?php endif; ?>
         </div>
     </fieldset>
