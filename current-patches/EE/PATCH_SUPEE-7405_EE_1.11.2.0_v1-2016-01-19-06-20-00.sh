...
SUPEE-7405-EE-1-11-2-0 | CE_1.6.2.0 | v1 | fa08f3b0216303579bcced87ba1e67ae9a54a863 | Tue Jan 19 14:41:05 2016 +0200 | f81091a5a3..fa08f3b021
...
index 22cedbe..cb4e737 100644
--- app/code/core/Mage/Adminhtml/controllers/IndexController.php
+++ app/code/core/Mage/Adminhtml/controllers/IndexController.php
@@ -229,39 +229,52 @@ class Mage_Adminhtml_IndexController extends Mage_Adminhtml_Controller_Action
      */
...
-            $this->_getSession()->addError(Mage::helper('adminhtml')->__('The email address is empty.'));
         ...
         $data = array(
@@ -299,10 +312,10 @@ class Mage_Adminhtml_IndexController extends Mage_Adminhtml_Controller_Action
      */
...
@@ -312,6 +325,12 @@ class Mage_Adminhtml_IndexController extends Mage_Adminhtml_Controller_Action
             return;
         }
