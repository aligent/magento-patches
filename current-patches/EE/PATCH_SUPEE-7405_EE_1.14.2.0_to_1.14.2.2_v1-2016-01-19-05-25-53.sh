...
SUPEE-7405-EE-1-14-2-2 | EE_1.14.2.2 | v1 | 91465c744a824111902e2911fd63fd8cb6c32f05 | Tue Jan 19 14:27:03 2016 +0200 | e1fc3c59c9..91465c744a
...
+        return $this->escapeHtml($this->_getQuote()->getCouponCode());
     ...
     /**
diff --git app/code/core/Enterprise/GoogleAnalyticsUniversal/Block/Ga.php app/code/core/Enterprise/GoogleAnalyticsUniversal/Block/Ga.php
index ec62b8b..0a9c703 100644
--- app/code/core/Enterprise/GoogleAnalyticsUniversal/Block/Ga.php
+++ app/code/core/Enterprise/GoogleAnalyticsUniversal/Block/Ga.php
...
-                <p id="cc_info"><strong><?php echo $this->getCouponCode(); ?></strong> [<a href="#" onclick="checkoutObj.applyCoupon();return false;" title="<?php echo Mage::helper('core')->jsQuoteEscape($this->__('Remove Coupon Code')) ?>"><?php echo $this->__('Remove') ?></a>]</p>
