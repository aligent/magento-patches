...
SUPEE-7405-EE-1-10-1-1 | EE_1.10.1.1 | v1 | a900f85303e92054748f8960f52830c0ca5f28da | Tue Jan 19 14:48:40 2016 +0200 | a661d1a941..a900f85303
...
+        return $this->escapeHtml($this->_getQuote()->getCouponCode());
     ...
     /**
diff --git app/code/core/Enterprise/Pci/Model/Mysql4/Admin/User.php app/code/core/Enterprise/Pci/Model/Mysql4/Admin/User.php
index 48f2cdf..3dd9df0 100644
--- app/code/core/Enterprise/Pci/Model/Mysql4/Admin/User.php
+++ app/code/core/Enterprise/Pci/Model/Mysql4/Admin/User.php
@@ -122,6 +122,8 @@ class Enterprise_Pci_Model_Mysql4_Admin_User extends Mage_Admin_Model_Mysql4_Use
...
@@ -298,4 +295,21 @@ class Mage_Admin_Model_Mysql4_User extends Mage_Core_Model_Mysql4_Abstract
         }
         return $this;
     }
+
...
@@ -183,4 +184,14 @@ class Mage_Adminhtml_Model_System_Config_Backend_File extends Mage_Core_Model_Co
     {
         return array();
     }
+
...
index 3897d2b..bbd00e1 100644
--- app/code/core/Mage/Catalog/Model/Resource/Eav/Mysql4/Product/Attribute/Backend/Image.php
+++ app/code/core/Mage/Catalog/Model/Resource/Eav/Mysql4/Product/Attribute/Backend/Image.php
@@ -51,18 +51,25 @@ class Mage_Catalog_Model_Resource_Eav_Mysql4_Product_Attribute_Backend_Image
             $uploader->setAllowedExtensions(array('jpg','jpeg','gif','png'));
             $uploader->setAllowRenameFiles(true);
...
@@ -404,16 +404,21 @@ class Mage_Checkout_CartController extends Mage_Core_Controller_Front_Action
      */
...
index c925f25..614929a 100644
--- app/code/core/Mage/Core/Model/App.php
+++ app/code/core/Mage/Core/Model/App.php
@@ -1207,6 +1207,7 @@ class Mage_Core_Model_App
...
index 3e482d0..7f804e9 100644
--- app/code/core/Mage/Sales/Model/Quote/Address.php
+++ app/code/core/Mage/Sales/Model/Quote/Address.php
@@ -906,7 +906,12 @@ class Mage_Sales_Model_Quote_Address extends Mage_Customer_Model_Address_Abstrac
      */
...
+    /**
      ...
      *
      * @var array
@@ -208,7 +215,7 @@ class Varien_File_Uploader
...
@@ -244,6 +251,14 @@ class Varien_File_Uploader
...
@@ -331,14 +346,17 @@ class Varien_File_Uploader
      * @access public
      * @return bool
      */
...
-        return true;
     ...
     /**
@@ -412,6 +430,21 @@ class Varien_File_Uploader
     }
...
@@ -486,7 +519,7 @@ class Varien_File_Uploader
